<script>
    ...
    export let onlyThumbnail = false; //boolean
    ...
    let showMenu =
        !onlyThumbnail && showMenuElements && showMenuElements.length > 0;
    let canvas;
    let page_num = 0;
    let pageCount = 0;
    let pdfDoc = null;
...
<svelte:window
    ...
    on:resize={() => queueRenderPage(pageNum)}
/>
                ...
                <div class="flex items-center">
                    ...
                    {:else}
                        <Tooltip>
                            <span
                                slot="activator"
                                class="button-control {pageNum <= 1
                                    ? 'disabled'
                                    : null}"
                                on:click={() => onPrevPage()}
                            >
                  ...
                  18.485 9.899 17.071 3.828 11 20 11 20 9 3.828 9"
                    ...
                    <div class="flex flex-col px-2 ">
                        <div class="text-center">
                            <div class="text-xs text-gray-500">Página</div>
                            <div class="">{pageNum} de {totalPage}</div>
                        </div>
                    </div>
                ...
                <div class="flex items-center">
                    ...
                    {:else}
                        <Tooltip>
                            <span
                                slot="activator"
                                class="button-control {scale <= minScale
                                    ? 'disabled'
                                    : null}"
                                on:click={() => onZoomOut()}
                            >
            ...
            7h6v2H5V7z"
                    ...
                    {:else}
                        <Tooltip>
                            <span
                                slot="activator"
                                class="button-control {scale >= maxScale
                                    ? 'disabled'
                                    : null}"
                                on:click={() => onZoomIn()}
                            >
